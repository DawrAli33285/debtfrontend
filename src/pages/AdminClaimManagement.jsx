  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Modal Header */}
        <div style={{
          background: '#1669A9', padding: '20px 24px',
            ...
            <div style={{ display: 'flex', gap: 10, paddingTop: 4 }}>
              <button
                ...
                style={{
                  ...
                  border: '1px solid #f1c0bc', background: '#fdf0ef',
                  color: '#c0392b', fontSize: 14, fontWeight: 600,
                  cursor: actionLoading ? 'not-allowed' : 'pointer',
                  fontFamily: 'inherit', opacity: actionLoading ? 0.55 : 1,
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7,
                  transition: 'background 0.15s',
                }}
              >
                {actionLoading === `deny-${claim._id}` ? <Spinner color="#c0392b" /> : (
                  <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> Deny Connection</>
                )}
              </button>
              <button
              ...
              >
                {actionLoading === `approve-${claim._id}` ? <Spinner color="#fff" /> : (
                  <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="20 6 9 17 4 12"/></svg> Approve Connection</>
                )}
              </button>
            </div>
          )}
...
function Section({ title, icon, children }) {
  return (
    <div style={{ border: '1px solid #e0e7ef', borderRadius: 12, overflow: 'hidden' }}>
      <div style={{
        background: '#1669A9', padding: '12px 18px',
        ...
        <div style={{
          width: 26, height: 26, background: 'rgba(255,255,255,0.15)',
      ...
      <div style={{ padding: '16px 18px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px 20px', background: '#fff' }}>
        {children}
      </div>
    </div>
  );
  ...
  return (
    <>
      ...
      <div style={{ padding: '28px 32px', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", minHeight: '100vh', background: '#f5f7fa' }}>
        ...
        {/* Page Header */}
        <div style={{ marginBottom: 28, animation: 'fadeUp 0.35s both' }}>
        ...
        <div style={{ background: '#fff', border: '1px solid #e0e7ef', borderRadius: 12, padding: '16px 20px', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', animation: 'fadeUp 0.45s both' }}>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  borderColor: filter === t.key ? '#1669A9' : '#e0e7ef',
                  background: filter === t.key ? '#e8f2fa' : 'transparent',
                  color: filter === t.key ? '#1669A9' : '#7a96a8',
          ...
          <div style={{ flex: 1, position: 'relative', minWidth: 200 }}>
            ...
            <input
              type="text"
              placeholder="Search by debtor, business, or agency…"
              value={search}
          ...
          <button onClick={fetchClaims} style={{
            padding: '8px 14px', borderRadius: 8, border: '1.5px solid #e0e7ef',
            background: '#fff', color: '#4a6070', fontSize: 12.5, fontWeight: 600,
                    ...
                    <td style={{ padding: '14px 20px' }} onClick={e => e.stopPropagation()}>
                      <div style={{ display: 'flex', gap: 6 }}>
                          ...
                          <>
                            <button
                              ...
                              style={{
                                ...
                                cursor: actionLoading ? 'not-allowed' : 'pointer',
                                opacity: actionLoading ? 0.55 : 1, transition: 'opacity 0.15s',
                              }}
                            >
                              {actionLoading === `deny-${claim._id}` ? <Spinner color="#c0392b" /> : (
                        ...
                        <button
                          ...
                          style={{
                            width: 32, height: 32, borderRadius: 8,
                            border: '1px solid #e0e7ef', background: '#f5f7fa',
                            color: '#4a6070', display: 'flex', alignItems: 'center', justifyContent: 'center',
